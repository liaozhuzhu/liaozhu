    ...
    <div className="overflow-hidden h-full relative flex items-center justify-center">
      <div className="flex flex-row flex-shrink-0 justify-center items-center gap-2">
          <Container className="h-8 w-8 circle-1">
            <PytorchLogo className="h-4 w-4 " />
          </Container>
          <Container className="h-12 w-12 circle-2">
            <DavinciLogo className="h-6 w-6 text-white" />
          </Container>
...
export const PytorchLogo = ({ className }: { className?: string }) => {
  return (
...
export const DavinciLogo = ({ className }: { className?: string }) => {
  return (
    <img
      className={className}
