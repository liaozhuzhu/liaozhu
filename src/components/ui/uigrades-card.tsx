    ...
    <div className="overflow-hidden h-full relative flex items-center justify-center">
      <div className="flex flex-row flex-shrink-0 justify-center items-center gap-2">
          ...
          <Container className="h-12 w-12 circle-2">
            <NodeLogo className="h-6 w-6 text-white object-contain" />
          </Container>
          <Container className="circle-3">
            <ReactLogo className="h-8 w-8 text-white object-cover" />
          </Container>
          <Container className="h-12 w-12 circle-4">
            <PythonLogo className="h-6 w-6 object-cover" />
          </Container>
          <Container className="h-8 w-8 circle-5">
            <SqlLogo className="h-4 w-4 " />
          </Container>
      </div>

      <div className="h-40 w-px absolute top-20 m-auto z-40 bg-gradient-to-b from-transparent via-zinc-900 to-transparent animate-move">
    ...
    <div className="absolute inset-0">
      {[...Array(12)].map((_, i) => (
        <motion.span
          ...
          className="inline-block bg-zinc-900"
        ></motion.span>
      ))}
    </div>
  );
  ...
  return (
    <div
      className={cn(
        ...
        className,
        showGradient &&
          " [mask-image:radial-gradient(90%_90%_at_50%_50%,white_0%,transparent_100%)]"
      )}
    >
      {children}
    </div>
...
export const SqlLogo = ({ className }: { className?: string }) => {
  return (
    <img
      className={className}
      src="/images/sql.png"
